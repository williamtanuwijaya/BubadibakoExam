<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link
                    :href="`/admin/exams/${exam.id_ujian}`"
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            pertanyaan: props.question.pertanyaan,
            pilihan_1: props.question.pilihan_1,
            pilihan_2: props.question.pilihan_2,
            pilihan_3: props.question.pilihan_3,
            pilihan_4: props.question.pilihan_4,
            pilihan_5: props.question.pilihan_5,
            jawaban: props.question.jawaban,
        });
        ...
        const submit = () => {
            //send data to server
            Inertia.put(
                `/admin/exams/${props.exam.id_ujian}/questions/${props.question.id_pertanyaan}/update`,
                {
                    //data
                    pertanyaan: form.pertanyaan,
                    pilihan_1: form.pilihan_1,
                    pilihan_2: form.pilihan_2,
                    pilihan_3: form.pilihan_3,
                    pilihan_4: form.pilihan_4,
                    pilihan_5: form.pilihan_5,
