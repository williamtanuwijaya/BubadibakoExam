<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/kelass" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                ...
                //send data to server
                Inertia.put(`/admin/kelas/${props.kelas.id}`, {
                    //data
