                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <Editor
                                    api-key="ry150ueth54xkb6gf97upluta01qc083zd2wa9ky0tqypydr"
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const form = reactive({
                nama_ujian: props.exam.nama_ujian,
                id_mapel: props.exam.id_mapel,
                id_kelas: props.exam.id_kelas,
                durasi: props.exam.durasi,
                deskripsi: props.exam.deskripsi,
                pertanyaan_acak: props.exam.pertanyaan_acak,
                jawaban_acak: props.exam.jawaban_acak,
                hasil: props.exam.hasil,
            });
            ...
            const submit = () => {
                ...
                //send data to server
                Inertia.put(`/admin/exams/${props.exam.id_ujian}`, {
                    //data
